...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_index('tipping_match', ['winner'])


    def backwards(self, orm):

        # Removing index on 'Match', fields ['winner']
        db.delete_index('tipping_match', ['winner'])
    ...
    models = {
        ...
        'tipping.match': {
            ...
            'winner': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '4', 'null': 'True', 'blank': 'True'})
        },
