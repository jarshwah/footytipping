...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Match.kickoff'
        db.add_column('tipping_match', 'kickoff', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 3, 19, 20, 38, 19, 164042)), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Match.kickoff'
        db.delete_column('tipping_match', 'kickoff')
