...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Match.winner'
        raise RuntimeError("Cannot reverse this migration. 'Match.winner' and its values cannot be restored.")
