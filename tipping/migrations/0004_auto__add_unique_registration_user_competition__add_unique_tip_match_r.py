...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Registration', fields ['user', 'competition']
        db.create_unique('tipping_registration', ['user_id', 'competition_id'])

        # Adding unique constraint on 'Tip', fields ['match', 'registration']
        db.create_unique('tipping_tip', ['match_id', 'registration_id'])

        # Adding field 'Competition.clean_sweep_extra_points'
        db.add_column('tipping_competition', 'clean_sweep_extra_points', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):

        # Removing unique constraint on 'Tip', fields ['match', 'registration']
        db.delete_unique('tipping_tip', ['match_id', 'registration_id'])

        # Removing unique constraint on 'Registration', fields ['user', 'competition']
        db.delete_unique('tipping_registration', ['user_id', 'competition_id'])

        # Deleting field 'Competition.clean_sweep_extra_points'
        db.delete_column('tipping_competition', 'clean_sweep_extra_points')
    ...
    models = {
        ...
        'tipping.match': {
            ...
            'winner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tipping.Team']", 'null': 'True', 'blank': 'True'})
        },
